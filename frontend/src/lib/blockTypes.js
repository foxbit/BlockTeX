...
export const BLOCK_TYPE_META = {
    [BLOCK_TYPES.CHAPTER]: {
        ...
        tagClass: 'tag-violet',
        color: '#8b5cf6',
        default_content: '<h1>Título do Capítulo</h1><p>Escreva seu conteúdo aqui usando formatação.</p><h2>Subseção</h2><p>Parágrafo de exemplo.</p>',
    },
    [BLOCK_TYPES.IMAGE]: {
        label: 'Imagem',
        icon: '🖼️',
    ...
    [BLOCK_TYPES.QUOTE]: {
        ...
        tagClass: 'tag-amber',
        color: '#f59e0b',
        default_content: '<p>"Esta é uma citação inspiradora que o leitor irá lembrar."</p><p>— Autor Desconhecido</p>',
    },
    [BLOCK_TYPES.CODE]: {
        label: 'Código',
        icon: '⚙️',
    ...
    [BLOCK_TYPES.TOC]: {
        ...
        tagClass: 'tag-rose',
        color: '#f43f5e',
        default_content: '<!-- TOC: Índice Automático -->\n<p>Será gerado automaticamente pelo LaTeX.</p>',
    },
