...
function generatePreamble(globalSetup, metadata) {
    ...
    const preamble = [
        ...
        '\\newunicodechar{á}{\\ifmmode\\text{\\char225}\\else\\char225\\fi}',
        '\\newunicodechar{ã}{\\ifmmode\\text{\\char227}\\else\\char227\\fi}',
        '\\newunicodechar{â}{\\ifmmode\\text{\\char226}\\else\\char226\\fi}',
        '\\newunicodechar{à}{\\ifmmode\\text{\\char224}\\else\\char224\\fi}',
        '\\newunicodechar{é}{\\ifmmode\\text{\\char233}\\else\\char233\\fi}',
        '\\newunicodechar{ê}{\\ifmmode\\text{\\char234}\\else\\char234\\fi}',
        '\\newunicodechar{í}{\\ifmmode\\text{\\char237}\\else\\char237\\fi}',
        '\\newunicodechar{ó}{\\ifmmode\\text{\\char243}\\else\\char243\\fi}',
        '\\newunicodechar{õ}{\\ifmmode\\text{\\char245}\\else\\char245\\fi}',
        '\\newunicodechar{ô}{\\ifmmode\\text{\\char244}\\else\\char244\\fi}',
        '\\newunicodechar{ú}{\\ifmmode\\text{\\char250}\\else\\char250\\fi}',
        '\\newunicodechar{ç}{\\ifmmode\\text{\\char231}\\else\\char231\\fi}',
        '\\newunicodechar{Á}{\\ifmmode\\text{\\char193}\\else\\char193\\fi}',
        '\\newunicodechar{Ã}{\\ifmmode\\text{\\char195}\\else\\char195\\fi}',
        '\\newunicodechar{Â}{\\ifmmode\\text{\\char194}\\else\\char194\\fi}',
        '\\newunicodechar{À}{\\ifmmode\\text{\\char192}\\else\\char192\\fi}',
        '\\newunicodechar{É}{\\ifmmode\\text{\\char201}\\else\\char201\\fi}',
        '\\newunicodechar{Ê}{\\ifmmode\\text{\\char202}\\else\\char202\\fi}',
        '\\newunicodechar{Í}{\\ifmmode\\text{\\char205}\\else\\char205\\fi}',
        '\\newunicodechar{Ó}{\\ifmmode\\text{\\char211}\\else\\char211\\fi}',
        '\\newunicodechar{Õ}{\\ifmmode\\text{\\char213}\\else\\char213\\fi}',
        '\\newunicodechar{Ô}{\\ifmmode\\text{\\char212}\\else\\char212\\fi}',
        '\\newunicodechar{Ú}{\\ifmmode\\text{\\char218}\\else\\char218\\fi}',
        '\\newunicodechar{Ç}{\\ifmmode\\text{\\char199}\\else\\char199\\fi}',
        '',
        '% ─── Graphics & Tables ──────────────────────────────',
        '\\usepackage{graphicx}',
        '\\usepackage{wrapfig}',
